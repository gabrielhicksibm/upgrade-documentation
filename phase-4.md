...
- [**Phase 4: Upgrading CP4BA (22.0.1)**](https://github.com/gabrielhicksibm/upgrade-documentation/blob/main/phases/phase-4.md)
  - [Step 1: Upgrade CP4BA to 22.0.1](#upgrade-cp4ba-to-2201)
- [Phase 5: Upgrading OpenShift (4.10-4.12)](https://github.com/gabrielhicksibm/upgrade-documentation/blob/main/phases/phase-5.md)

## Upgrade CP4BA to 22.0.1

- [22.0.1 Upgrade Documentation Steps](https://www.ibm.com/docs/en/cloud-paks/cp-biz-automation/22.0.1?topic=upgrading-cp4ba-clusters-from-2103)
- [Source for CASE Files](https://github.com/IBM/cloud-pak/blob/master/repo/case/ibm-cp-automation/4.0.2/ibm-cp-automation-4.0.2.tgz)
